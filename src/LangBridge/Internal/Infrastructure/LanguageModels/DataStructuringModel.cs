...
internal class DataStructuringModel : IDataStructuringModel
{
    ...
    private static string GeneralInstructions => "You are an agent who converts text to structured json. Your only job is to convert the user prompt in a json based on the provided schema.";
